...
public class CityMap extends Application {
    ...
    private static Pane challengePane;
    ...
    private Text challenge1 = new Text();
    private Text challenge2 = new Text();
    private Text challenge3 = new Text();
    private ImageView challenge2Image = new ImageView();
    private static boolean carChallengeDone = false;
    private static boolean busChallengeDone = false;
    private static boolean artChallengeDone = false;
    ...
    private void addEntities() {
        ...
        challenge1.setText("Challenge: Find all the letters in MSOE\n" +
                "Goal: MSOE\n" +
                "Found: ****\n\n");
        challenge2.setText("Challenge: Find Art!\n" +
                "Artistic works found:\n\n");
        challenge2Image.setFitHeight(200);
        challenge2Image.setFitWidth(200);

        challengePane.getChildren().addAll(challenge1, challenge2, challenge2Image, challenge3);


    }

    public static void updatePlateChallenge(String challenge, boolean carChallenge){
        Text currentText = (Text) challengePane.getChildren().get(0);
        currentText.setText(challenge);
        carChallengeDone = carChallenge;
        winner();

    }

    public void updateBusChallenge(String challenge, boolean busChallenge){
        Text currentText = (Text) challengePane.getChildren().get(3);
        currentText.setText(challenge);
        busChallengeDone = busChallenge;
        winner();
    }
    public void updateMuseumChallenge(){

        File file = new File("src\\mketour\\img\\wood-gatherer.png");
        Image image = new Image(file.toURI().toString());
        artChallengeDone = true;
        challenge2Image.setImage(image);
        winner();
    ...
    public static void winner(){
        if (carChallengeDone && busChallengeDone && artChallengeDone){
            Alert a = new Alert(Alert.AlertType.INFORMATION);
            a.setContentText("You are a winner");
            a.setOnHidden(evt -> Platform.exit());
